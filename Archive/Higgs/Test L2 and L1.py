...
def dw_pmad_b(w, X, b):
    ...
    projections = X @ w
    abs_diffs = pdist(projections.reshape(-1, 1), metric='sqeuclidean')  # Efficient pairwise differences，L2 here
...
if __name__ == '__main__':
    ...
    results_df.to_csv('parameter_sweep_results_HiggsL2.csv', index=False)
    print(results_df)
    print("Results exported to 'parameter_sweep_results_HiggsL2.csv'")
