...
plot_3d_scatter('../Dataset processing and testing/Fasttext/parameter_sweep_results_fasttext.csv', 'DW-PMAD vs. PCA Performance_Fasttext')
plot_3d_scatter('CIFAR-10/parameter_sweep_results_CIFAR-10.csv', 'DW-PMAD vs. PCA Performance_CIFAR-10')
plot_3d_scatter('../Dataset processing and testing/Isolet/parameter_sweep_results_Isolet.csv', 'DW-PMAD vs. PCA Performance_Isolet')
