...
b_values = [10,20,30,40,50,60,70,80,90]
...
# Load data
training_vectors = load_vectors('../Batch Process/training_vectors_600_Isolet.npy')
testing_vectors = load_vectors('../Batch Process/testing_vectors_600_Isolet.npy')
