...
if __name__ == '__main__':
    ...
    test_results_df.to_csv('parameter_sweep_results_Arcene_Multiple_methods.csv', index=False)
    print(test_results_df)
    print("Test results exported to 'parameter_sweep_results_Arcene_Multiple_methods.csv'")
