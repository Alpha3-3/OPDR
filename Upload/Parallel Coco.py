...
# Load data
training_vectors = load_vectors('training_vectors_600_Coco.npy')
testing_vectors = load_vectors('testing_vectors_600_Coco.npy')
...
if __name__ == '__main__':
    ...
    test_results_df.to_csv('parameter_sweep_results_Coco_Multiple_methods60.csv', index=False)
    print(test_results_df)
    print("Test results exported to 'parameter_sweep_results_Coco_Multiple_methods60.csv'")
