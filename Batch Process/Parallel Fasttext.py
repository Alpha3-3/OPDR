...
if __name__ == '__main__':
    ...
    dimensions_to_select_config = [300]
    target_ratios_for_dr_config = [0.05, 0.1, 0.2, 0.4, 0.6]


    print("Loading data...")
    try:
        train_file = 'training_vectors_1200_Fasttext.npy'
        test_file = 'testing_vectors_300_Fasttext.npy'
    ...
    output_excel_filename_val = 'parameter_sweep_ANN_SOTA_results_Fasttext.xlsx'
    output_csv_prefix = 'parameter_sweep_ANN_SOTA_results_Fasttext'
    ...
    output_report_filename_val = 'performance_report_SOTA_ANN_Fasttext.txt'
    with open(output_report_filename_val, 'w') as f_report_obj:
        f_report_obj.write("--- SOTA ANN Performance Report (Fasttext Dataset) ---\n\n")
