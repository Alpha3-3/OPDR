...
# Parameter settings
b_values = [100]  # Only used if DW-PMAD is enabled
k_values = [1,3, 6, 10, 15]
alpha_values = [3,4,5,6,7,8]  # Only used if DW-PMAD is enabled
...
if __name__ == '__main__':
    ...
    training_results_df.to_csv('training_accuracy_results_Isolet_Multiple_methods.csv', index=False)
    print(training_results_df)
    print("Training results exported to 'training_accuracy_results_Isolet_Multiple_methods.csv'")
