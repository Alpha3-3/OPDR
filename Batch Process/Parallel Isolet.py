...
if __name__ == '__main__':
    ...
    print("Loading data...")
    try:
        train_file = 'training_vectors_1200_Isolet.npy'
        test_file = 'testing_vectors_300_Isolet.npy'
    ...
    output_excel_filename_val = 'parameter_sweep_ANN_SOTA_results_Isolet.xlsx'
    output_csv_prefix = 'parameter_sweep_ANN_SOTA_results_Isolet'
    ...
    output_report_filename_val = 'performance_report_SOTA_ANN_Isolet.txt'
    with open(output_report_filename_val, 'w') as f_report_obj:
        f_report_obj.write("--- SOTA ANN Performance Report (Isolet Dataset) ---\n\n")
